...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-auto bg-white flex-row items-center justify-between flex gap-3 box-border p-4 font-bold text-blue-950 text-base  ">
      <div className=" w-2/12 px-10 h-full">Learning React</div>
      <div className=" w-2/4 ">
